"""Math Quiz Integration Project"""
__author__ = "Cameron Mckinley"
...
def main():
    """
    Prints the messages introducing the game, and then calls math function
    """
...
def math():
    """
    Asks the questions and tracks whether the user answers correctly or not.
    """
    ...
    if question1 == 108:
        # Adding 20 points to the users score
        answer1 += + 20
        print("Correct!")
        # print(answer1)
    else:
    ...
    # Program pauses for 2 second before letting the user know it's the final question
    time.sleep(2)
    print("Final Question\nThis one's just for fun, unlimited attempts.")
    time.sleep(2)
    # Program calls function play_game to start the guessing game
    play_game()
...
def play_game():
    """
    Generates a number between 1-100, prompts the user to guess and loops until user guesses correctly.
    """
...
def score(answer1, answer2, answer3, answer4, answer5):
    """
    Adds the users answers to get a score, prints the score along with a message.
    """
